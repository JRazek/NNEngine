...
int main(){
    ...
    std::vector< std::vector < int > > structure = {{1, 2, 3, 3, 1}, {1, 1, 3, 3, 2}, {2, 2, 2}, {0, 4, 24}, {0, 4, 4}, {0, 4, 4}};
    GeneticLearningUnit learningUnit = GeneticLearningUnit(structure, 10, 10);
    learningUnit.initPopulation(false, 1);
